  ...
  static _onSuccess(_PortModel msg) {
    ...
    switch (msg.callMethodName) {
      ...
      case _PortMethod.getSendGroupApplicationList:
        {
          if (msg.operationID != null) {
            _sendPortMap[msg.operationID!]?.send(_PortResult(data: IMUtils.toList(msg.data, (v) => GroupApplicationInfo.fromJson(v))));
            _sendPortMap.remove(msg.operationID!);
          }
        }
        break;
      ...
      case _PortMethod.disconnect:
      case _PortMethod.reconnection:
      case _PortMethod.networkChanged:
      case _PortMethod.getAllLocalKey:
      case _PortMethod.getLocalKey:
        {
          if (msg.operationID != null) {
      ...
      case _PortMethod.searchLocalMessages:
        {
          if (msg.operationID != null) {
            _sendPortMap[msg.operationID!]?.send(_PortResult(data: IMUtils.toObj(msg.data, (v) => SearchResult.fromJson(v))));
            _sendPortMap.remove(msg.operationID!);
          }
        }
        break;
    ...
    receivePort.listen((msg) {
      ...
      switch ((msg as _PortModel).method) {
        ...
        case _PortMethod.getLocalKey:
          _sendPortMap[msg.data['operationID']] = msg.sendPort!;
          final operationID = (msg.data['operationID'] as String).toNativeUtf8().cast<ffi.Char>();
          final sessionID = (msg.data['sessionID'] as String).toNativeUtf8().cast<ffi.Char>();
          _imBindings.GetLocalKey(operationID, sessionID, msg.data['sessionType']);
          calloc.free(operationID);
        ...
        case _PortMethod.getAllLocalKey:
          _sendPortMap[msg.data['operationID']] = msg.sendPort!;
          final operationID = (msg.data['operationID'] as String).toNativeUtf8().cast<ffi.Char>();
          _imBindings.GetAllLocalKey(operationID);
          calloc.free(operationID);
          break;
        case _PortMethod.disconnect:
          _sendPortMap[msg.data['operationID']] = msg.sendPort!;
          final operationID = (msg.data['operationID'] as String).toNativeUtf8().cast<ffi.Char>();
          _imBindings.Disconnect(operationID);
          calloc.free(operationID);
          break;
        case _PortMethod.reconnection:
          _sendPortMap[msg.data['operationID']] = msg.sendPort!;
          final operationID = (msg.data['operationID'] as String).toNativeUtf8().cast<ffi.Char>();
          _imBindings.Reconnection(operationID);
          calloc.free(operationID);
          break;
      }
    });
