...
class MeetingInfoList {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (meetingInfoList != null) {
      data['meetingInfoList'] = meetingInfoList!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class MeetingInfo {
  ...
  MeetingInfo.fromJson(Map<String, dynamic> json) {
    ...
    inviteeUserIDList = json['inviteeUserIDList'] == null ? null : (json['inviteeUserIDList'] as List).cast<String>();
    ...
    canScreenUserIDList = json['canScreenUserIDList'] == null ? null : (json['canScreenUserIDList'] as List).cast<String>();
    disableMicrophoneUserIDList =
        json['disableMicrophoneUserIDList'] == null ? null : (json['disableMicrophoneUserIDList'] as List).cast<String>();
    disableVideoUserIDList = json['disableVideoUserIDList'] == null ? null : (json['disableVideoUserIDList'] as List).cast<String>();
    pinedUserIDList = json['pinedUserIDList'] == null ? null : (json['pinedUserIDList'] as List).cast<String>();
    beWatchedUserIDList = json['beWatchedUserIDList'] == null ? null : (json['beWatchedUserIDList'] as List).cast<String>();
  }
