...
class SingleTypeKeyInfoSum {
  ...
  SingleTypeKeyInfoSum.fromJson(Map<String, dynamic> json) {
    ...
    infoList = json['infoList'] == null ? null : (json['infoList'] as List).map((e) => UserExInfo.fromJson(e)).toList();
...
class TypeKeySetResult {
  ...
  TypeKeySetResult({this.errCode, this.errMsg, this.typeKey, this.latestUpdateTime, this.value});
...
class MessageTypeKeyMapping {
  ...
  MessageTypeKeyMapping({this.errCode, this.errMsg, this.reactionExtensionList, this.clientMsgID});
  ...
  Map<String, dynamic> toJson() {
    ...
    if (reactionExtensionList != null) {
      data['reactionExtensionList'] = reactionExtensionList!.map((key, value) => MapEntry(key, value.toJson()));
    }
    data['clientMsgID'] = clientMsgID;
    return data;
  }
